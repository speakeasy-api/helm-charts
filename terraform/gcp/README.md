...
1. **Register a domain**: domain that will point to your speakeasy instance. For this you can use `Cloud DNS` or any other domain registrar. Worth noting that this step is not 100% necessary: you can still get speakeasy working without registering a domain using `kubectl portforward` (more information [here](./examples/no-ingress/README.md)).
