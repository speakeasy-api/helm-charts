...
module "aws_speakeasy" {
  ...
  # The module won't create kubernetes secret containing the client secret
  # of the Github Oauth app, the module assumes that secret already exists
  # having the below name and key
